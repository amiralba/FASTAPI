...
@app.post("/posts", status_code=status.HTTP_201_CREATED, response_model=List[schemas.Post]) #status_code age nazarim code 200 mide behemon defualteshe vase hamin 201 besh midim ke vase create kardane
